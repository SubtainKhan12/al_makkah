...
import '../../../InstallerPanel/DashboardScreens/Pending/PendingCustomerProfile/pendingCustomerProfile.dart';
...
class PendingComplainsUI extends StatefulWidget {
  TechnicianComparisonModel technicianComparison;
   PendingComplainsUI({super.key, required this.technicianComparison});

  @override
  State<PendingComplainsUI> createState() => _PendingComplainsUIState();
}

class _PendingComplainsUIState extends State<PendingComplainsUI> {
