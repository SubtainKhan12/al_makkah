...
import 'package:al_makkah/Models/PendingJobs/PendingJobsModel.dart';
...
class PendingCustomerDetails extends StatefulWidget {
  PendingJobsModel pendingJobsModel;
   PendingCustomerDetails({super.key,required this.pendingJobsModel});

  @override
  State<PendingCustomerDetails> createState() => _PendingCustomerDetailsState();
}

class _PendingCustomerDetailsState extends State<PendingCustomerDetails> {
  ...
  Future Post_GetJobInfo() async {
    var response = await http.post(Uri.parse(GetJobInfo), body: {
      'FJobNum': widget.pendingJobsModel.tjobnum.toString(),
    });
