...
class DoneCustomerDetails extends StatefulWidget {
  InstalledJobsModel installedJobsModel;
   DoneCustomerDetails({super.key,required this.installedJobsModel});

  @override
  State<DoneCustomerDetails> createState() => _DoneCustomerDetailsState();
}

class _DoneCustomerDetailsState extends State<DoneCustomerDetails> {
