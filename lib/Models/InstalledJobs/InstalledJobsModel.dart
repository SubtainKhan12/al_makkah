...
InstalledJobsModel installedJobsModelFromJson(String str) => InstalledJobsModel.fromJson(json.decode(str));
String installedJobsModelToJson(InstalledJobsModel data) => json.encode(data.toJson());
class InstalledJobsModel {
  InstalledJobsModel({
      String? id, 
      String? tjobnum, 
      String? tjobdat, 
  ...
  InstalledJobsModel.fromJson(dynamic json) {
    _id = json['id'];
  ...
  String? _category;
  String? _technician;
InstalledJobsModel copyWith({  String? id,
  String? tjobnum,
  String? tjobdat,
  String? tjobtim,
  String? tjobtyp,
