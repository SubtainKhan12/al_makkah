...
/// trat003 : null
/// trat004 : null
/// tclsrem : "warring adjust"
/// Company : "SUPER ASIA "
/// Category : "SUPER ASIA 5500"
/// Technician : "FAIZAN SHOP"
/// Mobile : "03296448084"

GetClosedJobsModel getClosedJobsModelFromJson(String str) => GetClosedJobsModel.fromJson(json.decode(str));
String getClosedJobsModelToJson(GetClosedJobsModel data) => json.encode(data.toJson());
class GetClosedJobsModel {
  GetClosedJobsModel({
      String? id, 
      String? tjobnum, 
      String? tjobdat, 
  ...
  GetClosedJobsModel.fromJson(dynamic json) {
    _id = json['id'];
  ...
  String? _technician;
  String? _mobile;
GetClosedJobsModel copyWith({  String? id,
  String? tjobnum,
  String? tjobdat,
  String? tjobtim,
  String? tjobtyp,
