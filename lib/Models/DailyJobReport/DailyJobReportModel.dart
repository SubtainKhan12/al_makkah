...
/// Company : "HAIR "
/// Category : "DRAWER"
/// Reference : "97331 LAHORE"
/// Technician : "IRFAN"
/// Mobile : "03053421934"
/// Days : "9"

DailyJobReportModel dailyJobReportModelFromJson(String str) => DailyJobReportModel.fromJson(json.decode(str));
String dailyJobReportModelToJson(DailyJobReportModel data) => json.encode(data.toJson());
class DailyJobReportModel {
  DailyJobReportModel({
      String? id, 
      String? tjobnum, 
      String? tjobdat, 
  ...
  DailyJobReportModel.fromJson(dynamic json) {
    _id = json['id'];
  ...
  String? _mobile;
  String? _days;
DailyJobReportModel copyWith({  String? id,
  String? tjobnum,
  String? tjobdat,
  String? tjobtim,
  String? tjobtyp,
