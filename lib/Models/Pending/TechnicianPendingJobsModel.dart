...
TechnicianPendingJobsModel technicianPendingJobsModelFromJson(String str) => TechnicianPendingJobsModel.fromJson(json.decode(str));
String technicianPendingJobsModelToJson(TechnicianPendingJobsModel data) => json.encode(data.toJson());
class TechnicianPendingJobsModel {
  TechnicianPendingJobsModel({
      String? id, 
      String? tjobnum, 
      String? tjobdat, 
      String? tjobtim, 
  ...
  TechnicianPendingJobsModel.fromJson(dynamic json) {
    _id = json['id'];
  ...
  String? _category;
  String? _technician;
TechnicianPendingJobsModel copyWith({  String? id,
  String? tjobnum,
  String? tjobdat,
  String? tjobtim,
  String? tjobtyp,
  ...
  String? category,
  String? technician,
}) => TechnicianPendingJobsModel(  id: id ?? _id,
